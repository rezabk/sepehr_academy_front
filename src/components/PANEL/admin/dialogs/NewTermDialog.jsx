...
import { newTerm } from "./../../../../core/services/termServices";

import { dashContext } from "./../../../context/dashContext";

const NewTermDialog = ({ showDialog, closeDialog }) => {
  const context = useContext(dashContext);
  const { coursesData, teachersData, setFetchTerm } = context;
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const { status } = await newTerm(term);
